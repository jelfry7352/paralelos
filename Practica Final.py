...
if __name__ == "__main__":
    banco= Banco("My Banco")
    
    cliente1 = Cliente("Yoemely", "El Proyecto Ama", "12345", banco)
    cliente2 = Cliente("Jelfry", "El Mamey", "67890", banco)

    cliente1.cuenta = Cuenta("12345", 30000, 5000, "Corriente")
    cliente2.cuenta = Cuenta("67890", 20000, 10000, "Ahorro")
    cajero = Cajero("Cajer0", "1525")
